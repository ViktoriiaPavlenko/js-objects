// экспортируем по дефолту из текущего файла функции для использования в других файлах
...
// == 2.1 через .key
// console.log('name: ', user.name); // Vika
...
// по-нормальному ES6
const moviesList = {
  moviesList: ['Inception', 'Tenet', 'The Prestige'],
  showMovies() {
